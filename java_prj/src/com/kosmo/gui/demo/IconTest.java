...
public class IconTest {
	...
	private void initialize() {
		...
		System.out.println(getClass().getResource("/com/kosmo/gui/demo/111.jpg").toString());
				
		ImageIcon defaultIcon = new ImageIcon(IconTest.class.getResource("/com/kosmo/gui/demo/111.jpg"));
...
//				String filename = "C:\\jp/workspace_java\\java_prj\\bin\\com\\kosmo\\gui\\demo\\aaa.jpg";
				String filename= getClass().getResource("/com/kosmo/gui/demo/111.jpg").toString();
